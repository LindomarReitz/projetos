...
public class Locadora {
	...
	public void cadastrarFilmes() {
		CategoriaDAO categoriaDAO = new CategoriaDAO();
		String[] filmesDescricao = {"Senhor do Anéis", "Transformers", "Ghostbusters"};
	...
	public static void main(String[] args) {
		...
		endereco.setBairro("Jardim Carolina");
		endereco.setCep("881600-000");
		endereco.setCidade("Biguaçu");
		endereco.setComplemento("Casa");
		endereco.setNumero(0);
		endereco.setRua("Rua 13");
		endereco.setUf("SC");
		enderecoDAO.salvar(endereco);
		
		ClienteDAO clienteDAO = new ClienteDAO();
		Cliente cliente = new Cliente();
		cliente.setCelular("(48) 9995-9995");
		cliente.setEmail("lindomar@making.com.br");
		cliente.setNome("Lindomar");
		cliente.setTelefone("(48) 3296-2645");	
		...
		MidiaDAO midiaDAO = new MidiaDAO();
		Midia midia = (Midia) midiaDAO.buscarMidia(1);
