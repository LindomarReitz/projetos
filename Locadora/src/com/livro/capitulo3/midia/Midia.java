...
public class Midia implements Serializable {
	...
	@Id
	@GeneratedValue(generator = "cod_midia", strategy = GenerationType.AUTO)
	@SequenceGenerator(name = "cod_midia", sequenceName = "midia_cod_midia_seq")
