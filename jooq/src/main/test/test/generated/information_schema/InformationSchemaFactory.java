...
public class InformationSchemaFactory extends org.jooq.util.postgres.PostgresFactory {
	...
	private static final long serialVersionUID = 1545279443;
	 ...
	 */
	public InformationSchemaFactory(javax.sql.DataSource dataSource) {
		super(dataSource);
	 ...
	 * 
	 * @deprecated - 2.0.5 - Use {@link #InformationSchemaFactory(java.sql.Connection, org.jooq.conf.Settings)} instead
	 */
	@Deprecated
	 ...
	 * @param settings The settings to apply to objects created from this factory
	 */
	public InformationSchemaFactory(javax.sql.DataSource dataSource, org.jooq.conf.Settings settings) {
	...
	private final void initDefaultSchema() {
		org.jooq.conf.SettingsTools.getRenderMapping(getSettings()).setDefaultSchema(test.generated.information_schema.InformationSchema.INFORMATION_SCHEMA.getName());
	}
}
