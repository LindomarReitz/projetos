...
public class Abstimeeq extends org.jooq.impl.AbstractRoutine<java.lang.Boolean> {

	private static final long serialVersionUID = 178510588;


	/**
	 * The procedure parameter <code>pg_catalog.abstimeeq.RETURN_VALUE</code>
	 */
	...
	/**
	 * The procedure parameter <code>pg_catalog.abstimeeq._1</code>
	 * <p>
	...
	/**
	 * The procedure parameter <code>pg_catalog.abstimeeq._2</code>
	 * <p>
	 * The SQL type of this item (abstime) could not be mapped.<br/>
	 * Deserialising this field might not work!
	 */
	 ...
	 */
	public Abstimeeq() {
		super("abstimeeq", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
	...
	public void set__1(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.Abstimeeq._1, value);
	}
	...
	public void set__2(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.Abstimeeq._2, value);
	}
