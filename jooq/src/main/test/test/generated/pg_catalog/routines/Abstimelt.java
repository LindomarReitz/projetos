...
public class Abstimelt extends org.jooq.impl.AbstractRoutine<java.lang.Boolean> {

	private static final long serialVersionUID = -1207506548;


	/**
	 * The procedure parameter <code>pg_catalog.abstimelt.RETURN_VALUE</code>
	 */
	...
	/**
	 * The procedure parameter <code>pg_catalog.abstimelt._1</code>
	 * <p>
	...
	/**
	 * The procedure parameter <code>pg_catalog.abstimelt._2</code>
	 * <p>
	 * The SQL type of this item (abstime) could not be mapped.<br/>
	 * Deserialising this field might not work!
	 */
	 ...
	 */
	public Abstimelt() {
		super("abstimelt", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
	...
	public void set__1(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.Abstimelt._1, value);
	}
	...
	public void set__2(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.Abstimelt._2, value);
	}
