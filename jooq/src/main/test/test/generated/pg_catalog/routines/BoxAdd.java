...
public class BoxAdd extends org.jooq.impl.AbstractRoutine<java.lang.Object> {

	private static final long serialVersionUID = -918066574;


	/**
	 * The procedure parameter <code>pg_catalog.box_add.RETURN_VALUE</code>
	 * <p>
	...
	/**
	 * The procedure parameter <code>pg_catalog.box_add._1</code>
	 * <p>
	 * The SQL type of this item (box) could not be mapped.<br/>
	 * Deserialising this field might not work!
	 */
	...
	/**
	 * The procedure parameter <code>pg_catalog.box_add._2</code>
	 * <p>
	 ...
	 */
	public BoxAdd() {
		super("box_add", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.util.postgres.PostgresDataType.getDefaultDataType("box"));
	...
	public void set__1(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.BoxAdd._1, value);
	}
	...
	public void set__2(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.BoxAdd._2, value);
	}
