...
public class BoxSub extends org.jooq.impl.AbstractRoutine<java.lang.Object> {

	private static final long serialVersionUID = -2105681486;


	/**
	 * The procedure parameter <code>pg_catalog.box_sub.RETURN_VALUE</code>
	 * <p>
	...
	/**
	 * The procedure parameter <code>pg_catalog.box_sub._1</code>
	 * <p>
	 * The SQL type of this item (box) could not be mapped.<br/>
	 * Deserialising this field might not work!
	 */
	...
	/**
	 * The procedure parameter <code>pg_catalog.box_sub._2</code>
	 * <p>
	 ...
	 */
	public BoxSub() {
		super("box_sub", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.util.postgres.PostgresDataType.getDefaultDataType("box"));
	...
	public void set__1(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.BoxSub._1, value);
	}
	...
	public void set__2(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.BoxSub._2, value);
	}
