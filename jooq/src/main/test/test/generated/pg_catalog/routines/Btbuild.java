...
public class Btbuild extends org.jooq.impl.AbstractRoutine<java.lang.Object> {

	private static final long serialVersionUID = 103061209;


	/**
	 * The procedure parameter <code>pg_catalog.btbuild.RETURN_VALUE</code>
	 * <p>
	...
	/**
	 * The procedure parameter <code>pg_catalog.btbuild._1</code>
	 * <p>
	 * The SQL type of this item (internal) could not be mapped.<br/>
	 * Deserialising this field might not work!
	 */
	...
	/**
	 * The procedure parameter <code>pg_catalog.btbuild._2</code>
	 * <p>
	 * The SQL type of this item (internal) could not be mapped.<br/>
	 * Deserialising this field might not work!
	 */
	...
	/**
	 * The procedure parameter <code>pg_catalog.btbuild._3</code>
	 * <p>
	 * The SQL type of this item (internal) could not be mapped.<br/>
	 * Deserialising this field might not work!
	 */
	 ...
	 */
	public Btbuild() {
		super("btbuild", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.util.postgres.PostgresDataType.getDefaultDataType("internal"));
	...
	public void set__1(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.Btbuild._1, value);
	}
	...
	public void set__2(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.Btbuild._2, value);
	}
	...
	public void set__3(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.Btbuild._3, value);
	}
