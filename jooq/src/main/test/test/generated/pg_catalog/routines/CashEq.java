...
public class CashEq extends org.jooq.impl.AbstractRoutine<java.lang.Boolean> {

	private static final long serialVersionUID = -2133060434;


	/**
	 * The procedure parameter <code>pg_catalog.cash_eq.RETURN_VALUE</code>
	 */
	 ...
	 */
	public CashEq() {
		super("cash_eq", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
	...
	public void set__1(java.math.BigDecimal value) {
		setValue(test.generated.pg_catalog.routines.CashEq._1, value);
	}
	...
	public void set__2(java.math.BigDecimal value) {
		setValue(test.generated.pg_catalog.routines.CashEq._2, value);
	}
