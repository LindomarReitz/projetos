...
public class CashLe extends org.jooq.impl.AbstractRoutine<java.lang.Boolean> {

	private static final long serialVersionUID = 1619573742;


	/**
	 * The procedure parameter <code>pg_catalog.cash_le.RETURN_VALUE</code>
	 */
	 ...
	 */
	public CashLe() {
		super("cash_le", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
	...
	public void set__1(java.math.BigDecimal value) {
		setValue(test.generated.pg_catalog.routines.CashLe._1, value);
	}
	...
	public void set__2(java.math.BigDecimal value) {
		setValue(test.generated.pg_catalog.routines.CashLe._2, value);
	}
