...
public class CircleOverlap extends org.jooq.impl.AbstractRoutine<java.lang.Boolean> {

	private static final long serialVersionUID = -1939606588;


	/**
	 * The procedure parameter <code>pg_catalog.circle_overlap.RETURN_VALUE</code>
	 */
	...
	/**
	 * The procedure parameter <code>pg_catalog.circle_overlap._1</code>
	 * <p>
	...
	/**
	 * The procedure parameter <code>pg_catalog.circle_overlap._2</code>
	 * <p>
	 * The SQL type of this item (circle) could not be mapped.<br/>
	 * Deserialising this field might not work!
	 */
	...
	public CircleOverlap() {
		super("circle_overlap", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
	...
	public void set__1(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.CircleOverlap._1, value);
	}
	...
	public void set__2(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.CircleOverlap._2, value);
	}
