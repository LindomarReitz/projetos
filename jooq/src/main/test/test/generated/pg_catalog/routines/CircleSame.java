...
public class CircleSame extends org.jooq.impl.AbstractRoutine<java.lang.Boolean> {

	private static final long serialVersionUID = 1623468752;


	/**
	 * The procedure parameter <code>pg_catalog.circle_same.RETURN_VALUE</code>
	 */
	...
	/**
	 * The procedure parameter <code>pg_catalog.circle_same._1</code>
	 * <p>
	...
	/**
	 * The procedure parameter <code>pg_catalog.circle_same._2</code>
	 * <p>
	 * The SQL type of this item (circle) could not be mapped.<br/>
	 * Deserialising this field might not work!
	 */
	 ...
	 */
	public CircleSame() {
		super("circle_same", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
	...
	public void set__1(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.CircleSame._1, value);
	}
	...
	public void set__2(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.CircleSame._2, value);
	}
