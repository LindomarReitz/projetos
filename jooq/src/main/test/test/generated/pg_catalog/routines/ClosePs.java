...
public class ClosePs extends org.jooq.impl.AbstractRoutine<java.lang.Object> {

	private static final long serialVersionUID = 244153747;


	/**
	 * The procedure parameter <code>pg_catalog.close_ps.RETURN_VALUE</code>
	 * <p>
	...
	/**
	 * The procedure parameter <code>pg_catalog.close_ps._1</code>
	 * <p>
	 * The SQL type of this item (point) could not be mapped.<br/>
	 * Deserialising this field might not work!
	 */
	...
	/**
	 * The procedure parameter <code>pg_catalog.close_ps._2</code>
	 * <p>
	 ...
	 */
	public ClosePs() {
		super("close_ps", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.util.postgres.PostgresDataType.getDefaultDataType("point"));
	...
	public void set__1(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.ClosePs._1, value);
	}
	...
	public void set__2(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.ClosePs._2, value);
	}
