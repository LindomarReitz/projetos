...
public class CstringIn extends org.jooq.impl.AbstractRoutine<java.lang.Object> {

	private static final long serialVersionUID = 802452835;


	/**
	 * The procedure parameter <code>pg_catalog.cstring_in.RETURN_VALUE</code>
	 * <p>
	...
	/**
	 * The procedure parameter <code>pg_catalog.cstring_in._1</code>
	 * <p>
	 * The SQL type of this item (cstring) could not be mapped.<br/>
	 * Deserialising this field might not work!
	 */
	 ...
	 */
	public CstringIn() {
		super("cstring_in", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.util.postgres.PostgresDataType.getDefaultDataType("cstring"));
	...
	public void set__1(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.CstringIn._1, value);
	}
