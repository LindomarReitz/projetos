...
public class DatabaseToXmlschema extends org.jooq.impl.AbstractRoutine<java.lang.Object> {

	private static final long serialVersionUID = 1042330404;


	/**
	 * The procedure parameter <code>pg_catalog.database_to_xmlschema.RETURN_VALUE</code>
	 * <p>
	...
	/**
	 * The procedure parameter <code>pg_catalog.database_to_xmlschema.nulls</code>
	 */
	public static final org.jooq.Parameter<java.lang.Boolean> NULLS = createParameter("nulls", org.jooq.impl.SQLDataType.BOOLEAN);

	/**
	 * The procedure parameter <code>pg_catalog.database_to_xmlschema.tableforest</code>
	 */
	...
	/**
	 * The procedure parameter <code>pg_catalog.database_to_xmlschema.targetns</code>
	 */
	...
	public DatabaseToXmlschema() {
		super("database_to_xmlschema", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.util.postgres.PostgresDataType.getDefaultDataType("xml"));
	...
	public void setNulls(java.lang.Boolean value) {
		setValue(test.generated.pg_catalog.routines.DatabaseToXmlschema.NULLS, value);
	}
	...
	public void setTableforest(java.lang.Boolean value) {
		setValue(test.generated.pg_catalog.routines.DatabaseToXmlschema.TABLEFOREST, value);
	}
	...
	public void setTargetns(java.lang.String value) {
		setValue(test.generated.pg_catalog.routines.DatabaseToXmlschema.TARGETNS, value);
	}
