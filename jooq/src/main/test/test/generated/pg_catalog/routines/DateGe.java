...
public class DateGe extends org.jooq.impl.AbstractRoutine<java.lang.Boolean> {

	private static final long serialVersionUID = -2120572976;


	/**
	 * The procedure parameter <code>pg_catalog.date_ge.RETURN_VALUE</code>
	 */
	...
	/**
	 * The procedure parameter <code>pg_catalog.date_ge._1</code>
	 */
	public static final org.jooq.Parameter<java.sql.Date> _1 = createParameter("_1", org.jooq.impl.SQLDataType.DATE);

	/**
	 * The procedure parameter <code>pg_catalog.date_ge._2</code>
	 */
	 ...
	 */
	public DateGe() {
		super("date_ge", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
	...
	public void set__1(java.sql.Date value) {
		setValue(test.generated.pg_catalog.routines.DateGe._1, value);
	}
	...
	public void set__2(java.sql.Date value) {
		setValue(test.generated.pg_catalog.routines.DateGe._2, value);
	}
