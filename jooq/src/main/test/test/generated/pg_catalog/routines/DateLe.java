...
public class DateLe extends org.jooq.impl.AbstractRoutine<java.lang.Boolean> {

	private static final long serialVersionUID = 466600380;


	/**
	 * The procedure parameter <code>pg_catalog.date_le.RETURN_VALUE</code>
	 */
	...
	/**
	 * The procedure parameter <code>pg_catalog.date_le._1</code>
	 */
	public static final org.jooq.Parameter<java.sql.Date> _1 = createParameter("_1", org.jooq.impl.SQLDataType.DATE);

	/**
	 * The procedure parameter <code>pg_catalog.date_le._2</code>
	 */
	 ...
	 */
	public DateLe() {
		super("date_le", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
	...
	public void set__1(java.sql.Date value) {
		setValue(test.generated.pg_catalog.routines.DateLe._1, value);
	}
	...
	public void set__2(java.sql.Date value) {
		setValue(test.generated.pg_catalog.routines.DateLe._2, value);
	}
