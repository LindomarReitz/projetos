...
public class DateMiInterval extends org.jooq.impl.AbstractRoutine<java.sql.Timestamp> {

	private static final long serialVersionUID = -843693736;


	/**
	 * The procedure parameter <code>pg_catalog.date_mi_interval.RETURN_VALUE</code>
	 */
	...
	/**
	 * The procedure parameter <code>pg_catalog.date_mi_interval._1</code>
	 */
	public static final org.jooq.Parameter<java.sql.Date> _1 = createParameter("_1", org.jooq.impl.SQLDataType.DATE);

	/**
	 * The procedure parameter <code>pg_catalog.date_mi_interval._2</code>
	 * <p>
	...
	public DateMiInterval() {
		super("date_mi_interval", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.TIMESTAMP);
	...
	public void set__1(java.sql.Date value) {
		setValue(test.generated.pg_catalog.routines.DateMiInterval._1, value);
	}
	...
	public void set__2(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.DateMiInterval._2, value);
	}
