...
public class Decode extends org.jooq.impl.AbstractRoutine<byte[]> {

	private static final long serialVersionUID = 1265650830;


	/**
	 * The procedure parameter <code>pg_catalog.decode.RETURN_VALUE</code>
	 */
	public static final org.jooq.Parameter<byte[]> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.BLOB);

	/**
	 * The procedure parameter <code>pg_catalog.decode._1</code>
	 */
	public static final org.jooq.Parameter<java.lang.String> _1 = createParameter("_1", org.jooq.impl.SQLDataType.CLOB);

	/**
	 * The procedure parameter <code>pg_catalog.decode._2</code>
	 */
	 ...
	 */
	public Decode() {
		super("decode", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BLOB);
	...
	public void set__1(java.lang.String value) {
		setValue(test.generated.pg_catalog.routines.Decode._1, value);
	}
	...
	public void set__2(java.lang.String value) {
		setValue(test.generated.pg_catalog.routines.Decode._2, value);
	}
