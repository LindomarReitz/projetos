...
public class DsynonymInit extends org.jooq.impl.AbstractRoutine<java.lang.Object> {

	private static final long serialVersionUID = -436010766;


	/**
	 * The procedure parameter <code>pg_catalog.dsynonym_init.RETURN_VALUE</code>
	 * <p>
	...
	/**
	 * The procedure parameter <code>pg_catalog.dsynonym_init._1</code>
	 * <p>
	 * The SQL type of this item (internal) could not be mapped.<br/>
	 * Deserialising this field might not work!
	 */
	 ...
	 */
	public DsynonymInit() {
		super("dsynonym_init", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.util.postgres.PostgresDataType.getDefaultDataType("internal"));
	...
	public void set__1(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.DsynonymInit._1, value);
	}
