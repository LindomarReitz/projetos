...
public class Float4in extends org.jooq.impl.AbstractRoutine<java.lang.Float> {

	private static final long serialVersionUID = 1439184599;


	/**
	 * The procedure parameter <code>pg_catalog.float4in.RETURN_VALUE</code>
	 */
	...
	/**
	 * The procedure parameter <code>pg_catalog.float4in._1</code>
	 * <p>
	 ...
	 */
	public Float4in() {
		super("float4in", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.REAL);
	...
	public void set__1(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.Float4in._1, value);
	}
