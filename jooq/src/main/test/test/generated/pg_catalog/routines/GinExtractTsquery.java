...
public class GinExtractTsquery extends org.jooq.impl.AbstractRoutine<java.lang.Object> {

	private static final long serialVersionUID = 567584821;


	/**
	 * The procedure parameter <code>pg_catalog.gin_extract_tsquery.RETURN_VALUE</code>
	 * <p>
	...
	/**
	 * The procedure parameter <code>pg_catalog.gin_extract_tsquery._1</code>
	 * <p>
	 * The SQL type of this item (tsquery) could not be mapped.<br/>
	 * Deserialising this field might not work!
	 */
	public static final org.jooq.Parameter<java.lang.Object> _1 = createParameter("_1", org.jooq.util.postgres.PostgresDataType.getDefaultDataType("tsquery"));

	/**
	 * The procedure parameter <code>pg_catalog.gin_extract_tsquery._2</code>
	 * <p>
	 * The SQL type of this item (internal) could not be mapped.<br/>
	 * Deserialising this field might not work!
	 */
	...
	/**
	 * The procedure parameter <code>pg_catalog.gin_extract_tsquery._3</code>
	 */
	public static final org.jooq.Parameter<java.lang.Short> _3 = createParameter("_3", org.jooq.impl.SQLDataType.SMALLINT);

	/**
	 * The procedure parameter <code>pg_catalog.gin_extract_tsquery._4</code>
	 * <p>
	 * The SQL type of this item (internal) could not be mapped.<br/>
	 * Deserialising this field might not work!
	 */
	...
	/**
	 * The procedure parameter <code>pg_catalog.gin_extract_tsquery._5</code>
	 * <p>
	 * The SQL type of this item (internal) could not be mapped.<br/>
	 * Deserialising this field might not work!
	 */
	 ...
	 */
	public GinExtractTsquery() {
		super("gin_extract_tsquery", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.util.postgres.PostgresDataType.getDefaultDataType("internal"));
	...
	public void set__1(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.GinExtractTsquery._1, value);
	}
	...
	public void set__2(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.GinExtractTsquery._2, value);
	}
	...
	public void set__3(java.lang.Short value) {
		setValue(test.generated.pg_catalog.routines.GinExtractTsquery._3, value);
	}
	...
	public void set__4(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.GinExtractTsquery._4, value);
	}
	...
	public void set__5(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.GinExtractTsquery._5, value);
	}
