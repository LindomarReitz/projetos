...
public class Gingetbitmap extends org.jooq.impl.AbstractRoutine<java.lang.Long> {

	private static final long serialVersionUID = 507843656;


	/**
	 * The procedure parameter <code>pg_catalog.gingetbitmap.RETURN_VALUE</code>
	 */
	...
	/**
	 * The procedure parameter <code>pg_catalog.gingetbitmap._1</code>
	 * <p>
	...
	/**
	 * The procedure parameter <code>pg_catalog.gingetbitmap._2</code>
	 * <p>
	 * The SQL type of this item (internal) could not be mapped.<br/>
	 * Deserialising this field might not work!
	 */
	 ...
	 */
	public Gingetbitmap() {
		super("gingetbitmap", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT);
	...
	public void set__1(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.Gingetbitmap._1, value);
	}
	...
	public void set__2(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.Gingetbitmap._2, value);
	}
