...
public class GistBoxUnion extends org.jooq.impl.AbstractRoutine<java.lang.Object> {

	private static final long serialVersionUID = -1290030274;


	/**
	 * The procedure parameter <code>pg_catalog.gist_box_union.RETURN_VALUE</code>
	 * <p>
	...
	/**
	 * The procedure parameter <code>pg_catalog.gist_box_union._1</code>
	 * <p>
	...
	/**
	 * The procedure parameter <code>pg_catalog.gist_box_union._2</code>
	 * <p>
	 * The SQL type of this item (internal) could not be mapped.<br/>
	 * Deserialising this field might not work!
	 */
	 ...
	 */
	public GistBoxUnion() {
		super("gist_box_union", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.util.postgres.PostgresDataType.getDefaultDataType("box"));
	...
	public void set__1(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.GistBoxUnion._1, value);
	}
	...
	public void set__2(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.GistBoxUnion._2, value);
	}
