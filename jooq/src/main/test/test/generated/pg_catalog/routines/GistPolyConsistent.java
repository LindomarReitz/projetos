...
public class GistPolyConsistent extends org.jooq.impl.AbstractRoutine<java.lang.Boolean> {

	private static final long serialVersionUID = -1160622420;


	/**
	 * The procedure parameter <code>pg_catalog.gist_poly_consistent.RETURN_VALUE</code>
	 */
	...
	/**
	 * The procedure parameter <code>pg_catalog.gist_poly_consistent._1</code>
	 * <p>
	...
	/**
	 * The procedure parameter <code>pg_catalog.gist_poly_consistent._2</code>
	 * <p>
	 * The SQL type of this item (polygon) could not be mapped.<br/>
	 * Deserialising this field might not work!
	 */
	public static final org.jooq.Parameter<java.lang.Object> _2 = createParameter("_2", org.jooq.util.postgres.PostgresDataType.getDefaultDataType("polygon"));

	/**
	 * The procedure parameter <code>pg_catalog.gist_poly_consistent._3</code>
	 */
	public static final org.jooq.Parameter<java.lang.Integer> _3 = createParameter("_3", org.jooq.impl.SQLDataType.INTEGER);

	/**
	 * The procedure parameter <code>pg_catalog.gist_poly_consistent._4</code>
	 */
	public static final org.jooq.Parameter<java.lang.Long> _4 = createParameter("_4", org.jooq.impl.SQLDataType.BIGINT);

	/**
	 * The procedure parameter <code>pg_catalog.gist_poly_consistent._5</code>
	 * <p>
	 * The SQL type of this item (internal) could not be mapped.<br/>
	 * Deserialising this field might not work!
	 */
	...
	public GistPolyConsistent() {
		super("gist_poly_consistent", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
	...
	public void set__1(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.GistPolyConsistent._1, value);
	}
	...
	public void set__2(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.GistPolyConsistent._2, value);
	}
	...
	public void set__3(java.lang.Integer value) {
		setValue(test.generated.pg_catalog.routines.GistPolyConsistent._3, value);
	}
	...
	public void set__4(java.lang.Long value) {
		setValue(test.generated.pg_catalog.routines.GistPolyConsistent._4, value);
	}
	...
	public void set__5(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.GistPolyConsistent._5, value);
	}
