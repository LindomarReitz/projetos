...
public class Hashgetbitmap extends org.jooq.impl.AbstractRoutine<java.lang.Long> {

	private static final long serialVersionUID = -433572640;


	/**
	 * The procedure parameter <code>pg_catalog.hashgetbitmap.RETURN_VALUE</code>
	 */
	...
	/**
	 * The procedure parameter <code>pg_catalog.hashgetbitmap._1</code>
	 * <p>
	...
	/**
	 * The procedure parameter <code>pg_catalog.hashgetbitmap._2</code>
	 * <p>
	 * The SQL type of this item (internal) could not be mapped.<br/>
	 * Deserialising this field might not work!
	 */
	...
	public Hashgetbitmap() {
		super("hashgetbitmap", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT);
	...
	public void set__1(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.Hashgetbitmap._1, value);
	}
	...
	public void set__2(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.Hashgetbitmap._2, value);
	}
