...
public class Hashgettuple extends org.jooq.impl.AbstractRoutine<java.lang.Boolean> {

	private static final long serialVersionUID = 840254636;


	/**
	 * The procedure parameter <code>pg_catalog.hashgettuple.RETURN_VALUE</code>
	 */
	...
	/**
	 * The procedure parameter <code>pg_catalog.hashgettuple._1</code>
	 * <p>
	...
	/**
	 * The procedure parameter <code>pg_catalog.hashgettuple._2</code>
	 * <p>
	 * The SQL type of this item (internal) could not be mapped.<br/>
	 * Deserialising this field might not work!
	 */
	 ...
	 */
	public Hashgettuple() {
		super("hashgettuple", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
	...
	public void set__1(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.Hashgettuple._1, value);
	}
	...
	public void set__2(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.Hashgettuple._2, value);
	}
