...
public class Int2Accum extends org.jooq.impl.AbstractRoutine<java.math.BigDecimal[]> {

	private static final long serialVersionUID = 212374336;


	/**
	 * The procedure parameter <code>pg_catalog.int2_accum.RETURN_VALUE</code>
	 */
	...
	/**
	 * The procedure parameter <code>pg_catalog.int2_accum._1</code>
	 */
	...
	/**
	 * The procedure parameter <code>pg_catalog.int2_accum._2</code>
	 */
	 ...
	 */
	public Int2Accum() {
		super("int2_accum", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.NUMERIC.getArrayDataType());
	...
	public void set__1(java.math.BigDecimal[] value) {
		setValue(test.generated.pg_catalog.routines.Int2Accum._1, value);
	}
	...
	public void set__2(java.lang.Short value) {
		setValue(test.generated.pg_catalog.routines.Int2Accum._2, value);
	}
