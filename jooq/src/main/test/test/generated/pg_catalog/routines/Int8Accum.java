...
public class Int8Accum extends org.jooq.impl.AbstractRoutine<java.math.BigDecimal[]> {

	private static final long serialVersionUID = -1739719551;


	/**
	 * The procedure parameter <code>pg_catalog.int8_accum.RETURN_VALUE</code>
	 */
	...
	/**
	 * The procedure parameter <code>pg_catalog.int8_accum._1</code>
	 */
	...
	/**
	 * The procedure parameter <code>pg_catalog.int8_accum._2</code>
	 */
	 ...
	 */
	public Int8Accum() {
		super("int8_accum", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.NUMERIC.getArrayDataType());
	...
	public void set__1(java.math.BigDecimal[] value) {
		setValue(test.generated.pg_catalog.routines.Int8Accum._1, value);
	}
	...
	public void set__2(java.lang.Long value) {
		setValue(test.generated.pg_catalog.routines.Int8Accum._2, value);
	}
