...
public class IntervalDiv extends org.jooq.impl.AbstractRoutine<java.lang.Object> {

	private static final long serialVersionUID = 126429098;


	/**
	 * The procedure parameter <code>pg_catalog.interval_div.RETURN_VALUE</code>
	 * <p>
	...
	/**
	 * The procedure parameter <code>pg_catalog.interval_div._1</code>
	 * <p>
	 * The SQL type of this item (interval) could not be mapped.<br/>
	 * Deserialising this field might not work!
	 */
	...
	/**
	 * The procedure parameter <code>pg_catalog.interval_div._2</code>
	 */
	 ...
	 */
	public IntervalDiv() {
		super("interval_div", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.util.postgres.PostgresDataType.getDefaultDataType("interval"));
	...
	public void set__1(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.IntervalDiv._1, value);
	}
	...
	public void set__2(java.lang.Double value) {
		setValue(test.generated.pg_catalog.routines.IntervalDiv._2, value);
	}
