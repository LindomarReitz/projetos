...
public class IntervalMul extends org.jooq.impl.AbstractRoutine<java.lang.Object> {

	private static final long serialVersionUID = -1929244182;


	/**
	 * The procedure parameter <code>pg_catalog.interval_mul.RETURN_VALUE</code>
	 * <p>
	...
	/**
	 * The procedure parameter <code>pg_catalog.interval_mul._1</code>
	 * <p>
	 * The SQL type of this item (interval) could not be mapped.<br/>
	 * Deserialising this field might not work!
	 */
	...
	/**
	 * The procedure parameter <code>pg_catalog.interval_mul._2</code>
	 */
	 ...
	 */
	public IntervalMul() {
		super("interval_mul", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.util.postgres.PostgresDataType.getDefaultDataType("interval"));
	...
	public void set__1(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.IntervalMul._1, value);
	}
	...
	public void set__2(java.lang.Double value) {
		setValue(test.generated.pg_catalog.routines.IntervalMul._2, value);
	}
