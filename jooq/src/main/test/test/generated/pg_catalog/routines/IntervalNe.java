...
public class IntervalNe extends org.jooq.impl.AbstractRoutine<java.lang.Boolean> {

	private static final long serialVersionUID = -2006995064;


	/**
	 * The procedure parameter <code>pg_catalog.interval_ne.RETURN_VALUE</code>
	 */
	...
	/**
	 * The procedure parameter <code>pg_catalog.interval_ne._1</code>
	 * <p>
	...
	/**
	 * The procedure parameter <code>pg_catalog.interval_ne._2</code>
	 * <p>
	 * The SQL type of this item (interval) could not be mapped.<br/>
	 * Deserialising this field might not work!
	 */
	 ...
	 */
	public IntervalNe() {
		super("interval_ne", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
	...
	public void set__1(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.IntervalNe._1, value);
	}
	...
	public void set__2(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.IntervalNe._2, value);
	}
