...
public class JustifyInterval extends org.jooq.impl.AbstractRoutine<java.lang.Object> {

	private static final long serialVersionUID = 1101972574;


	/**
	 * The procedure parameter <code>pg_catalog.justify_interval.RETURN_VALUE</code>
	 * <p>
	...
	/**
	 * The procedure parameter <code>pg_catalog.justify_interval._1</code>
	 * <p>
	 * The SQL type of this item (interval) could not be mapped.<br/>
	 * Deserialising this field might not work!
	 */
	...
	public JustifyInterval() {
		super("justify_interval", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.util.postgres.PostgresDataType.getDefaultDataType("interval"));
	...
	public void set__1(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.JustifyInterval._1, value);
	}
