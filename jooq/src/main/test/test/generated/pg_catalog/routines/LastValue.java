...
public class LastValue extends org.jooq.impl.AbstractRoutine<java.lang.Object> {

	private static final long serialVersionUID = -1299387037;


	/**
	 * The procedure parameter <code>pg_catalog.last_value.RETURN_VALUE</code>
	 * <p>
	...
	/**
	 * The procedure parameter <code>pg_catalog.last_value._1</code>
	 * <p>
	 * The SQL type of this item (anyelement) could not be mapped.<br/>
	 * Deserialising this field might not work!
	 */
	 ...
	 */
	public LastValue() {
		super("last_value", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.util.postgres.PostgresDataType.getDefaultDataType("anyelement"));
	...
	public void set__1(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.LastValue._1, value);
	}
