...
public class LsegInterpt extends org.jooq.impl.AbstractRoutine<java.lang.Object> {

	private static final long serialVersionUID = -237309783;


	/**
	 * The procedure parameter <code>pg_catalog.lseg_interpt.RETURN_VALUE</code>
	 * <p>
	...
	/**
	 * The procedure parameter <code>pg_catalog.lseg_interpt._1</code>
	 * <p>
	...
	/**
	 * The procedure parameter <code>pg_catalog.lseg_interpt._2</code>
	 * <p>
	 * The SQL type of this item (lseg) could not be mapped.<br/>
	 * Deserialising this field might not work!
	 */
	 ...
	 */
	public LsegInterpt() {
		super("lseg_interpt", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.util.postgres.PostgresDataType.getDefaultDataType("point"));
	...
	public void set__1(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.LsegInterpt._1, value);
	}
	...
	public void set__2(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.LsegInterpt._2, value);
	}
