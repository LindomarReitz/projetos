...
public class Min9 extends org.jooq.impl.AbstractRoutine<java.sql.Date> {

	private static final long serialVersionUID = -1733081505;
	 ...
	 */
	public Min9() {
		super("min", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DATE);
	...
	public void set__1(java.sql.Date value) {
		setValue(test.generated.pg_catalog.routines.Min9._1, value);
	}
