...
public class Nlikesel extends org.jooq.impl.AbstractRoutine<java.lang.Double> {

	private static final long serialVersionUID = -1938199441;


	/**
	 * The procedure parameter <code>pg_catalog.nlikesel.RETURN_VALUE</code>
	 */
	...
	/**
	 * The procedure parameter <code>pg_catalog.nlikesel._1</code>
	 * <p>
	...
	/**
	 * The procedure parameter <code>pg_catalog.nlikesel._2</code>
	 */
	public static final org.jooq.Parameter<java.lang.Long> _2 = createParameter("_2", org.jooq.impl.SQLDataType.BIGINT);

	/**
	 * The procedure parameter <code>pg_catalog.nlikesel._3</code>
	 * <p>
	 * The SQL type of this item (internal) could not be mapped.<br/>
	 * Deserialising this field might not work!
	 */
	...
	/**
	 * The procedure parameter <code>pg_catalog.nlikesel._4</code>
	 */
	 ...
	 */
	public Nlikesel() {
		super("nlikesel", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
	...
	public void set__1(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.Nlikesel._1, value);
	}
	...
	public void set__2(java.lang.Long value) {
		setValue(test.generated.pg_catalog.routines.Nlikesel._2, value);
	}
	...
	public void set__3(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.Nlikesel._3, value);
	}
	...
	public void set__4(java.lang.Integer value) {
		setValue(test.generated.pg_catalog.routines.Nlikesel._4, value);
	}
