...
public class PointMul extends org.jooq.impl.AbstractRoutine<java.lang.Object> {

	private static final long serialVersionUID = -2030280115;


	/**
	 * The procedure parameter <code>pg_catalog.point_mul.RETURN_VALUE</code>
	 * <p>
	...
	/**
	 * The procedure parameter <code>pg_catalog.point_mul._1</code>
	 * <p>
	 * The SQL type of this item (point) could not be mapped.<br/>
	 * Deserialising this field might not work!
	 */
	...
	/**
	 * The procedure parameter <code>pg_catalog.point_mul._2</code>
	 * <p>
	 * The SQL type of this item (point) could not be mapped.<br/>
	 * Deserialising this field might not work!
	 */
	 ...
	 */
	public PointMul() {
		super("point_mul", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.util.postgres.PostgresDataType.getDefaultDataType("point"));
	...
	public void set__1(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.PointMul._1, value);
	}
	...
	public void set__2(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.PointMul._2, value);
	}
