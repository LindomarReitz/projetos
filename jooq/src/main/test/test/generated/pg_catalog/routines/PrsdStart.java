...
public class PrsdStart extends org.jooq.impl.AbstractRoutine<java.lang.Object> {

	private static final long serialVersionUID = 928297328;


	/**
	 * The procedure parameter <code>pg_catalog.prsd_start.RETURN_VALUE</code>
	 * <p>
	...
	/**
	 * The procedure parameter <code>pg_catalog.prsd_start._1</code>
	 * <p>
	 * The SQL type of this item (internal) could not be mapped.<br/>
	 * Deserialising this field might not work!
	 */
	...
	/**
	 * The procedure parameter <code>pg_catalog.prsd_start._2</code>
	 */
	 ...
	 */
	public PrsdStart() {
		super("prsd_start", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.util.postgres.PostgresDataType.getDefaultDataType("internal"));
	...
	public void set__1(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.PrsdStart._1, value);
	}
	...
	public void set__2(java.lang.Integer value) {
		setValue(test.generated.pg_catalog.routines.PrsdStart._2, value);
	}
