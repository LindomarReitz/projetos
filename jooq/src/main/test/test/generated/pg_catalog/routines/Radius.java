...
public class Radius extends org.jooq.impl.AbstractRoutine<java.lang.Double> {

	private static final long serialVersionUID = 976410693;


	/**
	 * The procedure parameter <code>pg_catalog.radius.RETURN_VALUE</code>
	 */
	...
	/**
	 * The procedure parameter <code>pg_catalog.radius._1</code>
	 * <p>
	 ...
	 */
	public Radius() {
		super("radius", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
	...
	public void set__1(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.Radius._1, value);
	}
