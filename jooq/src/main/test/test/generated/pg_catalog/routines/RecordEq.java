...
public class RecordEq extends org.jooq.impl.AbstractRoutine<java.lang.Boolean> {

	private static final long serialVersionUID = 2066883770;


	/**
	 * The procedure parameter <code>pg_catalog.record_eq.RETURN_VALUE</code>
	 */
	...
	/**
	 * The procedure parameter <code>pg_catalog.record_eq._1</code>
	 * <p>
	...
	/**
	 * The procedure parameter <code>pg_catalog.record_eq._2</code>
	 * <p>
	 * The SQL type of this item (record) could not be mapped.<br/>
	 * Deserialising this field might not work!
	 */
	 ...
	 */
	public RecordEq() {
		super("record_eq", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
	...
	public void set__1(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.RecordEq._1, value);
	}
	...
	public void set__2(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.RecordEq._2, value);
	}
