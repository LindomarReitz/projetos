...
public class RecordLt extends org.jooq.impl.AbstractRoutine<java.lang.Boolean> {

	private static final long serialVersionUID = 1929809906;


	/**
	 * The procedure parameter <code>pg_catalog.record_lt.RETURN_VALUE</code>
	 */
	...
	/**
	 * The procedure parameter <code>pg_catalog.record_lt._1</code>
	 * <p>
	...
	/**
	 * The procedure parameter <code>pg_catalog.record_lt._2</code>
	 * <p>
	 * The SQL type of this item (record) could not be mapped.<br/>
	 * Deserialising this field might not work!
	 */
	 ...
	 */
	public RecordLt() {
		super("record_lt", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
	...
	public void set__1(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.RecordLt._1, value);
	}
	...
	public void set__2(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.RecordLt._2, value);
	}
