...
public class TimestampSmaller extends org.jooq.impl.AbstractRoutine<java.sql.Timestamp> {

	private static final long serialVersionUID = -620141450;


	/**
	 * The procedure parameter <code>pg_catalog.timestamp_smaller.RETURN_VALUE</code>
	 */
	...
	/**
	 * The procedure parameter <code>pg_catalog.timestamp_smaller._1</code>
	 */
	public static final org.jooq.Parameter<java.sql.Timestamp> _1 = createParameter("_1", org.jooq.impl.SQLDataType.TIMESTAMP);

	/**
	 * The procedure parameter <code>pg_catalog.timestamp_smaller._2</code>
	 */
	...
	public TimestampSmaller() {
		super("timestamp_smaller", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.TIMESTAMP);
	...
	public void set__1(java.sql.Timestamp value) {
		setValue(test.generated.pg_catalog.routines.TimestampSmaller._1, value);
	}
	...
	public void set__2(java.sql.Timestamp value) {
		setValue(test.generated.pg_catalog.routines.TimestampSmaller._2, value);
	}
