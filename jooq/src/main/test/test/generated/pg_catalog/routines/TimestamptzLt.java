...
public class TimestamptzLt extends org.jooq.impl.AbstractRoutine<java.lang.Boolean> {

	private static final long serialVersionUID = 1026922512;


	/**
	 * The procedure parameter <code>pg_catalog.timestamptz_lt.RETURN_VALUE</code>
	 */
	...
	/**
	 * The procedure parameter <code>pg_catalog.timestamptz_lt._1</code>
	 */
	public static final org.jooq.Parameter<java.sql.Timestamp> _1 = createParameter("_1", org.jooq.impl.SQLDataType.TIMESTAMP);

	/**
	 * The procedure parameter <code>pg_catalog.timestamptz_lt._2</code>
	 */
	...
	public TimestamptzLt() {
		super("timestamptz_lt", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
	...
	public void set__1(java.sql.Timestamp value) {
		setValue(test.generated.pg_catalog.routines.TimestamptzLt._1, value);
	}
	...
	public void set__2(java.sql.Timestamp value) {
		setValue(test.generated.pg_catalog.routines.TimestamptzLt._2, value);
	}
