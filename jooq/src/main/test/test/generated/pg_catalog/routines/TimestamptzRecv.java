...
public class TimestamptzRecv extends org.jooq.impl.AbstractRoutine<java.sql.Timestamp> {

	private static final long serialVersionUID = -1863150599;


	/**
	 * The procedure parameter <code>pg_catalog.timestamptz_recv.RETURN_VALUE</code>
	 */
	...
	/**
	 * The procedure parameter <code>pg_catalog.timestamptz_recv._1</code>
	 * <p>
	...
	/**
	 * The procedure parameter <code>pg_catalog.timestamptz_recv._2</code>
	 */
	public static final org.jooq.Parameter<java.lang.Long> _2 = createParameter("_2", org.jooq.impl.SQLDataType.BIGINT);

	/**
	 * The procedure parameter <code>pg_catalog.timestamptz_recv._3</code>
	 */
	...
	public TimestamptzRecv() {
		super("timestamptz_recv", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.TIMESTAMP);
	...
	public void set__1(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.TimestamptzRecv._1, value);
	}
	...
	public void set__2(java.lang.Long value) {
		setValue(test.generated.pg_catalog.routines.TimestamptzRecv._2, value);
	}
	...
	public void set__3(java.lang.Integer value) {
		setValue(test.generated.pg_catalog.routines.TimestamptzRecv._3, value);
	}
