...
public class TsMatchTq extends org.jooq.impl.AbstractRoutine<java.lang.Boolean> {

	private static final long serialVersionUID = -1187116907;


	/**
	 * The procedure parameter <code>pg_catalog.ts_match_tq.RETURN_VALUE</code>
	 */
	...
	/**
	 * The procedure parameter <code>pg_catalog.ts_match_tq._1</code>
	 */
	public static final org.jooq.Parameter<java.lang.String> _1 = createParameter("_1", org.jooq.impl.SQLDataType.CLOB);

	/**
	 * The procedure parameter <code>pg_catalog.ts_match_tq._2</code>
	 * <p>
	 ...
	 */
	public TsMatchTq() {
		super("ts_match_tq", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
	...
	public void set__1(java.lang.String value) {
		setValue(test.generated.pg_catalog.routines.TsMatchTq._1, value);
	}
	...
	public void set__2(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.TsMatchTq._2, value);
	}
