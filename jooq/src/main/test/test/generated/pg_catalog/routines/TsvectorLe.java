...
public class TsvectorLe extends org.jooq.impl.AbstractRoutine<java.lang.Boolean> {

	private static final long serialVersionUID = -777723342;


	/**
	 * The procedure parameter <code>pg_catalog.tsvector_le.RETURN_VALUE</code>
	 */
	...
	/**
	 * The procedure parameter <code>pg_catalog.tsvector_le._1</code>
	 * <p>
	...
	/**
	 * The procedure parameter <code>pg_catalog.tsvector_le._2</code>
	 * <p>
	 * The SQL type of this item (tsvector) could not be mapped.<br/>
	 * Deserialising this field might not work!
	 */
	 ...
	 */
	public TsvectorLe() {
		super("tsvector_le", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
	...
	public void set__1(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.TsvectorLe._1, value);
	}
	...
	public void set__2(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.TsvectorLe._2, value);
	}
