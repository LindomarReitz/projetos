...
public class Width extends org.jooq.impl.AbstractRoutine<java.lang.Double> {

	private static final long serialVersionUID = -1418022399;


	/**
	 * The procedure parameter <code>pg_catalog.width.RETURN_VALUE</code>
	 */
	...
	/**
	 * The procedure parameter <code>pg_catalog.width._1</code>
	 * <p>
	 ...
	 */
	public Width() {
		super("width", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
	...
	public void set__1(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.Width._1, value);
	}
