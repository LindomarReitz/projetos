...
public class XmlSend extends org.jooq.impl.AbstractRoutine<byte[]> {

	private static final long serialVersionUID = 653593286;


	/**
	 * The procedure parameter <code>pg_catalog.xml_send.RETURN_VALUE</code>
	 */
	public static final org.jooq.Parameter<byte[]> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.BLOB);

	/**
	 * The procedure parameter <code>pg_catalog.xml_send._1</code>
	 * <p>
	 ...
	 */
	public XmlSend() {
		super("xml_send", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BLOB);
	...
	public void set__1(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.XmlSend._1, value);
	}
