...
public class Xmlagg extends org.jooq.impl.AbstractRoutine<java.lang.Object> {

	private static final long serialVersionUID = 1670602579;


	/**
	 * The procedure parameter <code>pg_catalog.xmlagg.RETURN_VALUE</code>
	 * <p>
	...
	/**
	 * The procedure parameter <code>pg_catalog.xmlagg._1</code>
	 * <p>
	 * The SQL type of this item (xml) could not be mapped.<br/>
	 * Deserialising this field might not work!
	 */
	 ...
	 */
	public Xmlagg() {
		super("xmlagg", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.util.postgres.PostgresDataType.getDefaultDataType("xml"));
	...
	public void set__1(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.Xmlagg._1, value);
	}
