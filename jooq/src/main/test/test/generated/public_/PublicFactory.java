...
public class PublicFactory extends org.jooq.util.postgres.PostgresFactory {
	...
	private static final long serialVersionUID = 1905483858;
	...
	private final void initDefaultSchema() {
		org.jooq.conf.SettingsTools.getRenderMapping(getSettings()).setDefaultSchema(test.generated.public_.Public.PUBLIC.getName());
	}
}
