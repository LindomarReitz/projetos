...
public class Abstimele extends org.jooq.impl.AbstractRoutine<java.lang.Boolean> {

	private static final long serialVersionUID = 1717768520;


	/**
	 * The procedure parameter <code>pg_catalog.abstimele.RETURN_VALUE</code>
	 */
	...
	/**
	 * The procedure parameter <code>pg_catalog.abstimele._1</code>
	 * <p>
	...
	/**
	 * The procedure parameter <code>pg_catalog.abstimele._2</code>
	 * <p>
	 * The SQL type of this item (abstime) could not be mapped.<br/>
	 * Deserialising this field might not work!
	 */
	 ...
	 */
	public Abstimele() {
		super("abstimele", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
	...
	public void set__1(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.Abstimele._1, value);
	}
	...
	public void set__2(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.Abstimele._2, value);
	}
