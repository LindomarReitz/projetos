...
public class Abstimene extends org.jooq.impl.AbstractRoutine<java.lang.Boolean> {

	private static final long serialVersionUID = 1366208848;


	/**
	 * The procedure parameter <code>pg_catalog.abstimene.RETURN_VALUE</code>
	 */
	...
	/**
	 * The procedure parameter <code>pg_catalog.abstimene._1</code>
	 * <p>
	...
	/**
	 * The procedure parameter <code>pg_catalog.abstimene._2</code>
	 * <p>
	 * The SQL type of this item (abstime) could not be mapped.<br/>
	 * Deserialising this field might not work!
	 */
	 ...
	 */
	public Abstimene() {
		super("abstimene", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
	...
	public void set__1(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.Abstimene._1, value);
	}
	...
	public void set__2(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.Abstimene._2, value);
	}
