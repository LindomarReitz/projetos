...
public class BoxDiv extends org.jooq.impl.AbstractRoutine<java.lang.Object> {

	private static final long serialVersionUID = -1601970574;


	/**
	 * The procedure parameter <code>pg_catalog.box_div.RETURN_VALUE</code>
	 * <p>
	...
	/**
	 * The procedure parameter <code>pg_catalog.box_div._1</code>
	 * <p>
	 * The SQL type of this item (box) could not be mapped.<br/>
	 * Deserialising this field might not work!
	 */
	...
	/**
	 * The procedure parameter <code>pg_catalog.box_div._2</code>
	 * <p>
	 ...
	 */
	public BoxDiv() {
		super("box_div", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.util.postgres.PostgresDataType.getDefaultDataType("box"));
	...
	public void set__1(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.BoxDiv._1, value);
	}
	...
	public void set__2(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.BoxDiv._2, value);
	}
