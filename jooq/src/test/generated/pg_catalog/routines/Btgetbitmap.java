...
public class Btgetbitmap extends org.jooq.impl.AbstractRoutine<java.lang.Long> {

	private static final long serialVersionUID = 1646145112;


	/**
	 * The procedure parameter <code>pg_catalog.btgetbitmap.RETURN_VALUE</code>
	 */
	...
	/**
	 * The procedure parameter <code>pg_catalog.btgetbitmap._1</code>
	 * <p>
	...
	/**
	 * The procedure parameter <code>pg_catalog.btgetbitmap._2</code>
	 * <p>
	 * The SQL type of this item (internal) could not be mapped.<br/>
	 * Deserialising this field might not work!
	 */
	 ...
	 */
	public Btgetbitmap() {
		super("btgetbitmap", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT);
	...
	public void set__1(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.Btgetbitmap._1, value);
	}
	...
	public void set__2(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.Btgetbitmap._2, value);
	}
