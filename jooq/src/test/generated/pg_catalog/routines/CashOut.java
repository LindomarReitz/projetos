...
public class CashOut extends org.jooq.impl.AbstractRoutine<java.lang.Object> {

	private static final long serialVersionUID = 1563002413;


	/**
	 * The procedure parameter <code>pg_catalog.cash_out.RETURN_VALUE</code>
	 * <p>
	...
	/**
	 * The procedure parameter <code>pg_catalog.cash_out._1</code>
	 */
	 ...
	 */
	public CashOut() {
		super("cash_out", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.util.postgres.PostgresDataType.getDefaultDataType("cstring"));
	...
	public void set__1(java.math.BigDecimal value) {
		setValue(test.generated.pg_catalog.routines.CashOut._1, value);
	}
