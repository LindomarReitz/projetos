...
public class CircleAbove extends org.jooq.impl.AbstractRoutine<java.lang.Boolean> {

	private static final long serialVersionUID = -2004477032;


	/**
	 * The procedure parameter <code>pg_catalog.circle_above.RETURN_VALUE</code>
	 */
	...
	/**
	 * The procedure parameter <code>pg_catalog.circle_above._1</code>
	 * <p>
	...
	/**
	 * The procedure parameter <code>pg_catalog.circle_above._2</code>
	 * <p>
	 * The SQL type of this item (circle) could not be mapped.<br/>
	 * Deserialising this field might not work!
	 */
	 ...
	 */
	public CircleAbove() {
		super("circle_above", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
	...
	public void set__1(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.CircleAbove._1, value);
	}
	...
	public void set__2(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.CircleAbove._2, value);
	}
