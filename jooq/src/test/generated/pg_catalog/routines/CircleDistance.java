...
public class CircleDistance extends org.jooq.impl.AbstractRoutine<java.lang.Double> {

	private static final long serialVersionUID = -564239030;


	/**
	 * The procedure parameter <code>pg_catalog.circle_distance.RETURN_VALUE</code>
	 */
	...
	/**
	 * The procedure parameter <code>pg_catalog.circle_distance._1</code>
	 * <p>
	...
	/**
	 * The procedure parameter <code>pg_catalog.circle_distance._2</code>
	 * <p>
	 * The SQL type of this item (circle) could not be mapped.<br/>
	 * Deserialising this field might not work!
	 */
	...
	public CircleDistance() {
		super("circle_distance", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
	...
	public void set__1(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.CircleDistance._1, value);
	}
	...
	public void set__2(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.CircleDistance._2, value);
	}
