...
public class CircleGe extends org.jooq.impl.AbstractRoutine<java.lang.Boolean> {

	private static final long serialVersionUID = -2093666688;


	/**
	 * The procedure parameter <code>pg_catalog.circle_ge.RETURN_VALUE</code>
	 */
	...
	/**
	 * The procedure parameter <code>pg_catalog.circle_ge._1</code>
	 * <p>
	...
	/**
	 * The procedure parameter <code>pg_catalog.circle_ge._2</code>
	 * <p>
	 * The SQL type of this item (circle) could not be mapped.<br/>
	 * Deserialising this field might not work!
	 */
	 ...
	 */
	public CircleGe() {
		super("circle_ge", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
	...
	public void set__1(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.CircleGe._1, value);
	}
	...
	public void set__2(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.CircleGe._2, value);
	}
