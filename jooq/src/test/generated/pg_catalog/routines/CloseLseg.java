...
public class CloseLseg extends org.jooq.impl.AbstractRoutine<java.lang.Object> {

	private static final long serialVersionUID = 645480489;


	/**
	 * The procedure parameter <code>pg_catalog.close_lseg.RETURN_VALUE</code>
	 * <p>
	...
	/**
	 * The procedure parameter <code>pg_catalog.close_lseg._1</code>
	 * <p>
	...
	/**
	 * The procedure parameter <code>pg_catalog.close_lseg._2</code>
	 * <p>
	 * The SQL type of this item (lseg) could not be mapped.<br/>
	 * Deserialising this field might not work!
	 */
	 ...
	 */
	public CloseLseg() {
		super("close_lseg", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.util.postgres.PostgresDataType.getDefaultDataType("point"));
	...
	public void set__1(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.CloseLseg._1, value);
	}
	...
	public void set__2(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.CloseLseg._2, value);
	}
