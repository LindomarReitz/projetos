...
public class CstringOut extends org.jooq.impl.AbstractRoutine<java.lang.Object> {

	private static final long serialVersionUID = 1395262597;


	/**
	 * The procedure parameter <code>pg_catalog.cstring_out.RETURN_VALUE</code>
	 * <p>
	...
	/**
	 * The procedure parameter <code>pg_catalog.cstring_out._1</code>
	 * <p>
	 * The SQL type of this item (cstring) could not be mapped.<br/>
	 * Deserialising this field might not work!
	 */
	 ...
	 */
	public CstringOut() {
		super("cstring_out", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.util.postgres.PostgresDataType.getDefaultDataType("cstring"));
	...
	public void set__1(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.CstringOut._1, value);
	}
