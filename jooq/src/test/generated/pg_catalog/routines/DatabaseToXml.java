...
public class DatabaseToXml extends org.jooq.impl.AbstractRoutine<java.lang.Object> {

	private static final long serialVersionUID = -1855873054;


	/**
	 * The procedure parameter <code>pg_catalog.database_to_xml.RETURN_VALUE</code>
	 * <p>
	...
	/**
	 * The procedure parameter <code>pg_catalog.database_to_xml.nulls</code>
	 */
	public static final org.jooq.Parameter<java.lang.Boolean> NULLS = createParameter("nulls", org.jooq.impl.SQLDataType.BOOLEAN);

	/**
	 * The procedure parameter <code>pg_catalog.database_to_xml.tableforest</code>
	 */
	...
	/**
	 * The procedure parameter <code>pg_catalog.database_to_xml.targetns</code>
	 */
	...
	public DatabaseToXml() {
		super("database_to_xml", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.util.postgres.PostgresDataType.getDefaultDataType("xml"));
	...
	public void setNulls(java.lang.Boolean value) {
		setValue(test.generated.pg_catalog.routines.DatabaseToXml.NULLS, value);
	}
	...
	public void setTableforest(java.lang.Boolean value) {
		setValue(test.generated.pg_catalog.routines.DatabaseToXml.TABLEFOREST, value);
	}
	...
	public void setTargetns(java.lang.String value) {
		setValue(test.generated.pg_catalog.routines.DatabaseToXml.TARGETNS, value);
	}
