...
public class DsimpleLexize extends org.jooq.impl.AbstractRoutine<java.lang.Object> {

	private static final long serialVersionUID = -2037047778;


	/**
	 * The procedure parameter <code>pg_catalog.dsimple_lexize.RETURN_VALUE</code>
	 * <p>
	...
	/**
	 * The procedure parameter <code>pg_catalog.dsimple_lexize._1</code>
	 * <p>
	 * The SQL type of this item (internal) could not be mapped.<br/>
	 * Deserialising this field might not work!
	 */
	...
	/**
	 * The procedure parameter <code>pg_catalog.dsimple_lexize._2</code>
	 * <p>
	 * The SQL type of this item (internal) could not be mapped.<br/>
	 * Deserialising this field might not work!
	 */
	...
	/**
	 * The procedure parameter <code>pg_catalog.dsimple_lexize._3</code>
	 * <p>
	 * The SQL type of this item (internal) could not be mapped.<br/>
	 * Deserialising this field might not work!
	 */
	...
	/**
	 * The procedure parameter <code>pg_catalog.dsimple_lexize._4</code>
	 * <p>
	 * The SQL type of this item (internal) could not be mapped.<br/>
	 * Deserialising this field might not work!
	 */
	...
	public DsimpleLexize() {
		super("dsimple_lexize", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.util.postgres.PostgresDataType.getDefaultDataType("internal"));
	...
	public void set__1(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.DsimpleLexize._1, value);
	}
	...
	public void set__2(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.DsimpleLexize._2, value);
	}
	...
	public void set__3(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.DsimpleLexize._3, value);
	}
	...
	public void set__4(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.DsimpleLexize._4, value);
	}
