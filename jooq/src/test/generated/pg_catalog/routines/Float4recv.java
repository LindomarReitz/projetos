...
public class Float4recv extends org.jooq.impl.AbstractRoutine<java.lang.Float> {

	private static final long serialVersionUID = -52777909;


	/**
	 * The procedure parameter <code>pg_catalog.float4recv.RETURN_VALUE</code>
	 */
	...
	/**
	 * The procedure parameter <code>pg_catalog.float4recv._1</code>
	 * <p>
	 ...
	 */
	public Float4recv() {
		super("float4recv", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.REAL);
	...
	public void set__1(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.Float4recv._1, value);
	}
