...
public class Gistgetbitmap extends org.jooq.impl.AbstractRoutine<java.lang.Long> {

	private static final long serialVersionUID = 1983076246;


	/**
	 * The procedure parameter <code>pg_catalog.gistgetbitmap.RETURN_VALUE</code>
	 */
	...
	/**
	 * The procedure parameter <code>pg_catalog.gistgetbitmap._1</code>
	 * <p>
	...
	/**
	 * The procedure parameter <code>pg_catalog.gistgetbitmap._2</code>
	 * <p>
	 * The SQL type of this item (internal) could not be mapped.<br/>
	 * Deserialising this field might not work!
	 */
	...
	public Gistgetbitmap() {
		super("gistgetbitmap", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT);
	...
	public void set__1(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.Gistgetbitmap._1, value);
	}
	...
	public void set__2(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.Gistgetbitmap._2, value);
	}
