...
public class Gistgettuple extends org.jooq.impl.AbstractRoutine<java.lang.Boolean> {

	private static final long serialVersionUID = -1315125864;


	/**
	 * The procedure parameter <code>pg_catalog.gistgettuple.RETURN_VALUE</code>
	 */
	...
	/**
	 * The procedure parameter <code>pg_catalog.gistgettuple._1</code>
	 * <p>
	...
	/**
	 * The procedure parameter <code>pg_catalog.gistgettuple._2</code>
	 * <p>
	 * The SQL type of this item (internal) could not be mapped.<br/>
	 * Deserialising this field might not work!
	 */
	 ...
	 */
	public Gistgettuple() {
		super("gistgettuple", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
	...
	public void set__1(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.Gistgettuple._1, value);
	}
	...
	public void set__2(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.Gistgettuple._2, value);
	}
