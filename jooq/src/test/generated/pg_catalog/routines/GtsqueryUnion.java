...
public class GtsqueryUnion extends org.jooq.impl.AbstractRoutine<java.lang.Object> {

	private static final long serialVersionUID = -354216736;


	/**
	 * The procedure parameter <code>pg_catalog.gtsquery_union.RETURN_VALUE</code>
	 * <p>
	...
	/**
	 * The procedure parameter <code>pg_catalog.gtsquery_union._1</code>
	 * <p>
	 * The SQL type of this item (internal) could not be mapped.<br/>
	 * Deserialising this field might not work!
	 */
	...
	/**
	 * The procedure parameter <code>pg_catalog.gtsquery_union._2</code>
	 * <p>
	 * The SQL type of this item (internal) could not be mapped.<br/>
	 * Deserialising this field might not work!
	 */
	...
	public GtsqueryUnion() {
		super("gtsquery_union", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.util.postgres.PostgresDataType.getDefaultDataType("internal"));
	...
	public void set__1(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.GtsqueryUnion._1, value);
	}
	...
	public void set__2(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.GtsqueryUnion._2, value);
	}
