...
public class IntervalLarger extends org.jooq.impl.AbstractRoutine<java.lang.Object> {

	private static final long serialVersionUID = -332763904;


	/**
	 * The procedure parameter <code>pg_catalog.interval_larger.RETURN_VALUE</code>
	 * <p>
	...
	/**
	 * The procedure parameter <code>pg_catalog.interval_larger._1</code>
	 * <p>
	 * The SQL type of this item (interval) could not be mapped.<br/>
	 * Deserialising this field might not work!
	 */
	...
	/**
	 * The procedure parameter <code>pg_catalog.interval_larger._2</code>
	 * <p>
	 * The SQL type of this item (interval) could not be mapped.<br/>
	 * Deserialising this field might not work!
	 */
	...
	public IntervalLarger() {
		super("interval_larger", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.util.postgres.PostgresDataType.getDefaultDataType("interval"));
	...
	public void set__1(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.IntervalLarger._1, value);
	}
	...
	public void set__2(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.IntervalLarger._2, value);
	}
