...
public class IntervalUm extends org.jooq.impl.AbstractRoutine<java.lang.Object> {

	private static final long serialVersionUID = 880132634;


	/**
	 * The procedure parameter <code>pg_catalog.interval_um.RETURN_VALUE</code>
	 * <p>
	...
	/**
	 * The procedure parameter <code>pg_catalog.interval_um._1</code>
	 * <p>
	 * The SQL type of this item (interval) could not be mapped.<br/>
	 * Deserialising this field might not work!
	 */
	 ...
	 */
	public IntervalUm() {
		super("interval_um", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.util.postgres.PostgresDataType.getDefaultDataType("interval"));
	...
	public void set__1(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.IntervalUm._1, value);
	}
