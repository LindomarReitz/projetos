...
public class JustifyHours extends org.jooq.impl.AbstractRoutine<java.lang.Object> {

	private static final long serialVersionUID = -1049266966;


	/**
	 * The procedure parameter <code>pg_catalog.justify_hours.RETURN_VALUE</code>
	 * <p>
	...
	/**
	 * The procedure parameter <code>pg_catalog.justify_hours._1</code>
	 * <p>
	 * The SQL type of this item (interval) could not be mapped.<br/>
	 * Deserialising this field might not work!
	 */
	 ...
	 */
	public JustifyHours() {
		super("justify_hours", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.util.postgres.PostgresDataType.getDefaultDataType("interval"));
	...
	public void set__1(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.JustifyHours._1, value);
	}
