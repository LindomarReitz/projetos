...
public class Loread extends org.jooq.impl.AbstractRoutine<byte[]> {

	private static final long serialVersionUID = 825659034;


	/**
	 * The procedure parameter <code>pg_catalog.loread.RETURN_VALUE</code>
	 */
	public static final org.jooq.Parameter<byte[]> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.BLOB);

	/**
	 * The procedure parameter <code>pg_catalog.loread._1</code>
	 */
	public static final org.jooq.Parameter<java.lang.Integer> _1 = createParameter("_1", org.jooq.impl.SQLDataType.INTEGER);

	/**
	 * The procedure parameter <code>pg_catalog.loread._2</code>
	 */
	 ...
	 */
	public Loread() {
		super("loread", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BLOB);
	...
	public void set__1(java.lang.Integer value) {
		setValue(test.generated.pg_catalog.routines.Loread._1, value);
	}
	...
	public void set__2(java.lang.Integer value) {
		setValue(test.generated.pg_catalog.routines.Loread._2, value);
	}
