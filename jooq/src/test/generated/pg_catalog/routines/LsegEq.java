...
public class LsegEq extends org.jooq.impl.AbstractRoutine<java.lang.Boolean> {

	private static final long serialVersionUID = 2080338250;


	/**
	 * The procedure parameter <code>pg_catalog.lseg_eq.RETURN_VALUE</code>
	 */
	...
	/**
	 * The procedure parameter <code>pg_catalog.lseg_eq._1</code>
	 * <p>
	...
	/**
	 * The procedure parameter <code>pg_catalog.lseg_eq._2</code>
	 * <p>
	 * The SQL type of this item (lseg) could not be mapped.<br/>
	 * Deserialising this field might not work!
	 */
	 ...
	 */
	public LsegEq() {
		super("lseg_eq", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
	...
	public void set__1(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.LsegEq._1, value);
	}
	...
	public void set__2(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.LsegEq._2, value);
	}
