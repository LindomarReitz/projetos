...
public class LsegLt extends org.jooq.impl.AbstractRoutine<java.lang.Boolean> {

	private static final long serialVersionUID = 1288534146;


	/**
	 * The procedure parameter <code>pg_catalog.lseg_lt.RETURN_VALUE</code>
	 */
	...
	/**
	 * The procedure parameter <code>pg_catalog.lseg_lt._1</code>
	 * <p>
	...
	/**
	 * The procedure parameter <code>pg_catalog.lseg_lt._2</code>
	 * <p>
	 * The SQL type of this item (lseg) could not be mapped.<br/>
	 * Deserialising this field might not work!
	 */
	 ...
	 */
	public LsegLt() {
		super("lseg_lt", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
	...
	public void set__1(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.LsegLt._1, value);
	}
	...
	public void set__2(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.LsegLt._2, value);
	}
