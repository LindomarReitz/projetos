...
public class LsegParallel extends org.jooq.impl.AbstractRoutine<java.lang.Boolean> {

	private static final long serialVersionUID = -1441118048;


	/**
	 * The procedure parameter <code>pg_catalog.lseg_parallel.RETURN_VALUE</code>
	 */
	...
	/**
	 * The procedure parameter <code>pg_catalog.lseg_parallel._1</code>
	 * <p>
	...
	/**
	 * The procedure parameter <code>pg_catalog.lseg_parallel._2</code>
	 * <p>
	 * The SQL type of this item (lseg) could not be mapped.<br/>
	 * Deserialising this field might not work!
	 */
	 ...
	 */
	public LsegParallel() {
		super("lseg_parallel", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
	...
	public void set__1(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.LsegParallel._1, value);
	}
	...
	public void set__2(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.LsegParallel._2, value);
	}
