...
public class PointDiv extends org.jooq.impl.AbstractRoutine<java.lang.Object> {

	private static final long serialVersionUID = 684272909;


	/**
	 * The procedure parameter <code>pg_catalog.point_div.RETURN_VALUE</code>
	 * <p>
	...
	/**
	 * The procedure parameter <code>pg_catalog.point_div._1</code>
	 * <p>
	 * The SQL type of this item (point) could not be mapped.<br/>
	 * Deserialising this field might not work!
	 */
	...
	/**
	 * The procedure parameter <code>pg_catalog.point_div._2</code>
	 * <p>
	 * The SQL type of this item (point) could not be mapped.<br/>
	 * Deserialising this field might not work!
	 */
	 ...
	 */
	public PointDiv() {
		super("point_div", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.util.postgres.PostgresDataType.getDefaultDataType("point"));
	...
	public void set__1(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.PointDiv._1, value);
	}
	...
	public void set__2(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.PointDiv._2, value);
	}
