...
public class PointNe extends org.jooq.impl.AbstractRoutine<java.lang.Boolean> {

	private static final long serialVersionUID = 220486752;


	/**
	 * The procedure parameter <code>pg_catalog.point_ne.RETURN_VALUE</code>
	 */
	...
	/**
	 * The procedure parameter <code>pg_catalog.point_ne._1</code>
	 * <p>
	...
	/**
	 * The procedure parameter <code>pg_catalog.point_ne._2</code>
	 * <p>
	 * The SQL type of this item (point) could not be mapped.<br/>
	 * Deserialising this field might not work!
	 */
	 ...
	 */
	public PointNe() {
		super("point_ne", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
	...
	public void set__1(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.PointNe._1, value);
	}
	...
	public void set__2(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.PointNe._2, value);
	}
