...
public class PolySend extends org.jooq.impl.AbstractRoutine<byte[]> {

	private static final long serialVersionUID = -1970996592;


	/**
	 * The procedure parameter <code>pg_catalog.poly_send.RETURN_VALUE</code>
	 */
	public static final org.jooq.Parameter<byte[]> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.BLOB);

	/**
	 * The procedure parameter <code>pg_catalog.poly_send._1</code>
	 * <p>
	 ...
	 */
	public PolySend() {
		super("poly_send", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BLOB);
	...
	public void set__1(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.PolySend._1, value);
	}
