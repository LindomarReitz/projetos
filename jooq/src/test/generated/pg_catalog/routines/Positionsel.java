...
public class Positionsel extends org.jooq.impl.AbstractRoutine<java.lang.Double> {

	private static final long serialVersionUID = -779030783;


	/**
	 * The procedure parameter <code>pg_catalog.positionsel.RETURN_VALUE</code>
	 */
	...
	/**
	 * The procedure parameter <code>pg_catalog.positionsel._1</code>
	 * <p>
	...
	/**
	 * The procedure parameter <code>pg_catalog.positionsel._2</code>
	 */
	public static final org.jooq.Parameter<java.lang.Long> _2 = createParameter("_2", org.jooq.impl.SQLDataType.BIGINT);

	/**
	 * The procedure parameter <code>pg_catalog.positionsel._3</code>
	 * <p>
	 * The SQL type of this item (internal) could not be mapped.<br/>
	 * Deserialising this field might not work!
	 */
	...
	/**
	 * The procedure parameter <code>pg_catalog.positionsel._4</code>
	 */
	 ...
	 */
	public Positionsel() {
		super("positionsel", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
	...
	public void set__1(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.Positionsel._1, value);
	}
	...
	public void set__2(java.lang.Long value) {
		setValue(test.generated.pg_catalog.routines.Positionsel._2, value);
	}
	...
	public void set__3(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.Positionsel._3, value);
	}
	...
	public void set__4(java.lang.Integer value) {
		setValue(test.generated.pg_catalog.routines.Positionsel._4, value);
	}
