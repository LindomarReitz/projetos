...
public class SetByte extends org.jooq.impl.AbstractRoutine<byte[]> {

	private static final long serialVersionUID = 1070434665;


	/**
	 * The procedure parameter <code>pg_catalog.set_byte.RETURN_VALUE</code>
	 */
	public static final org.jooq.Parameter<byte[]> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.BLOB);

	/**
	 * The procedure parameter <code>pg_catalog.set_byte._1</code>
	 */
	public static final org.jooq.Parameter<byte[]> _1 = createParameter("_1", org.jooq.impl.SQLDataType.BLOB);

	/**
	 * The procedure parameter <code>pg_catalog.set_byte._2</code>
	 */
	public static final org.jooq.Parameter<java.lang.Integer> _2 = createParameter("_2", org.jooq.impl.SQLDataType.INTEGER);

	/**
	 * The procedure parameter <code>pg_catalog.set_byte._3</code>
	 */
	 ...
	 */
	public SetByte() {
		super("set_byte", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BLOB);
	...
	public void set__1(byte[] value) {
		setValue(test.generated.pg_catalog.routines.SetByte._1, value);
	}
	...
	public void set__2(java.lang.Integer value) {
		setValue(test.generated.pg_catalog.routines.SetByte._2, value);
	}
	...
	public void set__3(java.lang.Integer value) {
		setValue(test.generated.pg_catalog.routines.SetByte._3, value);
	}
