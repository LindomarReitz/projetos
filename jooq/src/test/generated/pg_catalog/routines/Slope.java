...
public class Slope extends org.jooq.impl.AbstractRoutine<java.lang.Double> {

	private static final long serialVersionUID = -391710890;


	/**
	 * The procedure parameter <code>pg_catalog.slope.RETURN_VALUE</code>
	 */
	...
	/**
	 * The procedure parameter <code>pg_catalog.slope._1</code>
	 * <p>
	...
	/**
	 * The procedure parameter <code>pg_catalog.slope._2</code>
	 * <p>
	 * The SQL type of this item (point) could not be mapped.<br/>
	 * Deserialising this field might not work!
	 */
	 ...
	 */
	public Slope() {
		super("slope", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
	...
	public void set__1(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.Slope._1, value);
	}
	...
	public void set__2(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.Slope._2, value);
	}
