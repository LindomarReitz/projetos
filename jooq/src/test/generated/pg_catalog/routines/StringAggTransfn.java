...
public class StringAggTransfn extends org.jooq.impl.AbstractRoutine<java.lang.Object> {

	private static final long serialVersionUID = -1460569377;


	/**
	 * The procedure parameter <code>pg_catalog.string_agg_transfn.RETURN_VALUE</code>
	 * <p>
	...
	/**
	 * The procedure parameter <code>pg_catalog.string_agg_transfn._1</code>
	 * <p>
	 * The SQL type of this item (internal) could not be mapped.<br/>
	 * Deserialising this field might not work!
	 */
	...
	/**
	 * The procedure parameter <code>pg_catalog.string_agg_transfn._2</code>
	 */
	public static final org.jooq.Parameter<java.lang.String> _2 = createParameter("_2", org.jooq.impl.SQLDataType.CLOB);

	/**
	 * The procedure parameter <code>pg_catalog.string_agg_transfn._3</code>
	 */
	...
	public StringAggTransfn() {
		super("string_agg_transfn", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.util.postgres.PostgresDataType.getDefaultDataType("internal"));
	...
	public void set__1(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.StringAggTransfn._1, value);
	}
	...
	public void set__2(java.lang.String value) {
		setValue(test.generated.pg_catalog.routines.StringAggTransfn._2, value);
	}
	...
	public void set__3(java.lang.String value) {
		setValue(test.generated.pg_catalog.routines.StringAggTransfn._3, value);
	}
