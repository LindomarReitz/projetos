...
public class TimeEq extends org.jooq.impl.AbstractRoutine<java.lang.Boolean> {

	private static final long serialVersionUID = 963577796;


	/**
	 * The procedure parameter <code>pg_catalog.time_eq.RETURN_VALUE</code>
	 */
	...
	/**
	 * The procedure parameter <code>pg_catalog.time_eq._1</code>
	 */
	public static final org.jooq.Parameter<java.sql.Time> _1 = createParameter("_1", org.jooq.impl.SQLDataType.TIME);

	/**
	 * The procedure parameter <code>pg_catalog.time_eq._2</code>
	 */
	 ...
	 */
	public TimeEq() {
		super("time_eq", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
	...
	public void set__1(java.sql.Time value) {
		setValue(test.generated.pg_catalog.routines.TimeEq._1, value);
	}
	...
	public void set__2(java.sql.Time value) {
		setValue(test.generated.pg_catalog.routines.TimeEq._2, value);
	}
