...
public class TimeLe extends org.jooq.impl.AbstractRoutine<java.lang.Boolean> {

	private static final long serialVersionUID = 1891471224;


	/**
	 * The procedure parameter <code>pg_catalog.time_le.RETURN_VALUE</code>
	 */
	...
	/**
	 * The procedure parameter <code>pg_catalog.time_le._1</code>
	 */
	public static final org.jooq.Parameter<java.sql.Time> _1 = createParameter("_1", org.jooq.impl.SQLDataType.TIME);

	/**
	 * The procedure parameter <code>pg_catalog.time_le._2</code>
	 */
	 ...
	 */
	public TimeLe() {
		super("time_le", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
	...
	public void set__1(java.sql.Time value) {
		setValue(test.generated.pg_catalog.routines.TimeLe._1, value);
	}
	...
	public void set__2(java.sql.Time value) {
		setValue(test.generated.pg_catalog.routines.TimeLe._2, value);
	}
