...
public class TimestampGt extends org.jooq.impl.AbstractRoutine<java.lang.Boolean> {

	private static final long serialVersionUID = 1039786492;


	/**
	 * The procedure parameter <code>pg_catalog.timestamp_gt.RETURN_VALUE</code>
	 */
	...
	/**
	 * The procedure parameter <code>pg_catalog.timestamp_gt._1</code>
	 */
	public static final org.jooq.Parameter<java.sql.Timestamp> _1 = createParameter("_1", org.jooq.impl.SQLDataType.TIMESTAMP);

	/**
	 * The procedure parameter <code>pg_catalog.timestamp_gt._2</code>
	 */
	 ...
	 */
	public TimestampGt() {
		super("timestamp_gt", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
	...
	public void set__1(java.sql.Timestamp value) {
		setValue(test.generated.pg_catalog.routines.TimestampGt._1, value);
	}
	...
	public void set__2(java.sql.Timestamp value) {
		setValue(test.generated.pg_catalog.routines.TimestampGt._2, value);
	}
