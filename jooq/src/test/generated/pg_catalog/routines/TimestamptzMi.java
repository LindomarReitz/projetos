...
public class TimestamptzMi extends org.jooq.impl.AbstractRoutine<java.lang.Object> {

	private static final long serialVersionUID = -104604998;


	/**
	 * The procedure parameter <code>pg_catalog.timestamptz_mi.RETURN_VALUE</code>
	 * <p>
	...
	/**
	 * The procedure parameter <code>pg_catalog.timestamptz_mi._1</code>
	 */
	public static final org.jooq.Parameter<java.sql.Timestamp> _1 = createParameter("_1", org.jooq.impl.SQLDataType.TIMESTAMP);

	/**
	 * The procedure parameter <code>pg_catalog.timestamptz_mi._2</code>
	 */
	...
	public TimestamptzMi() {
		super("timestamptz_mi", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.util.postgres.PostgresDataType.getDefaultDataType("interval"));
	...
	public void set__1(java.sql.Timestamp value) {
		setValue(test.generated.pg_catalog.routines.TimestamptzMi._1, value);
	}
	...
	public void set__2(java.sql.Timestamp value) {
		setValue(test.generated.pg_catalog.routines.TimestamptzMi._2, value);
	}
