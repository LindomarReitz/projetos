...
public class TimetzPlInterval extends org.jooq.impl.AbstractRoutine<java.sql.Time> {

	private static final long serialVersionUID = -282504024;


	/**
	 * The procedure parameter <code>pg_catalog.timetz_pl_interval.RETURN_VALUE</code>
	 */
	...
	/**
	 * The procedure parameter <code>pg_catalog.timetz_pl_interval._1</code>
	 */
	public static final org.jooq.Parameter<java.sql.Time> _1 = createParameter("_1", org.jooq.impl.SQLDataType.TIME);

	/**
	 * The procedure parameter <code>pg_catalog.timetz_pl_interval._2</code>
	 * <p>
	...
	public TimetzPlInterval() {
		super("timetz_pl_interval", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.TIME);
	...
	public void set__1(java.sql.Time value) {
		setValue(test.generated.pg_catalog.routines.TimetzPlInterval._1, value);
	}
	...
	public void set__2(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.TimetzPlInterval._2, value);
	}
