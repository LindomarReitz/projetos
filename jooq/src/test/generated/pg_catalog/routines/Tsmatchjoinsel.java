...
public class Tsmatchjoinsel extends org.jooq.impl.AbstractRoutine<java.lang.Double> {

	private static final long serialVersionUID = -1376866788;


	/**
	 * The procedure parameter <code>pg_catalog.tsmatchjoinsel.RETURN_VALUE</code>
	 */
	...
	/**
	 * The procedure parameter <code>pg_catalog.tsmatchjoinsel._1</code>
	 * <p>
	...
	/**
	 * The procedure parameter <code>pg_catalog.tsmatchjoinsel._2</code>
	 */
	public static final org.jooq.Parameter<java.lang.Long> _2 = createParameter("_2", org.jooq.impl.SQLDataType.BIGINT);

	/**
	 * The procedure parameter <code>pg_catalog.tsmatchjoinsel._3</code>
	 * <p>
	 * The SQL type of this item (internal) could not be mapped.<br/>
	 * Deserialising this field might not work!
	 */
	...
	/**
	 * The procedure parameter <code>pg_catalog.tsmatchjoinsel._4</code>
	 */
	public static final org.jooq.Parameter<java.lang.Short> _4 = createParameter("_4", org.jooq.impl.SQLDataType.SMALLINT);

	/**
	 * The procedure parameter <code>pg_catalog.tsmatchjoinsel._5</code>
	 * <p>
	 * The SQL type of this item (internal) could not be mapped.<br/>
	 * Deserialising this field might not work!
	 */
	...
	public Tsmatchjoinsel() {
		super("tsmatchjoinsel", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
	...
	public void set__1(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.Tsmatchjoinsel._1, value);
	}
	...
	public void set__2(java.lang.Long value) {
		setValue(test.generated.pg_catalog.routines.Tsmatchjoinsel._2, value);
	}
	...
	public void set__3(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.Tsmatchjoinsel._3, value);
	}
	...
	public void set__4(java.lang.Short value) {
		setValue(test.generated.pg_catalog.routines.Tsmatchjoinsel._4, value);
	}
	...
	public void set__5(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.Tsmatchjoinsel._5, value);
	}
