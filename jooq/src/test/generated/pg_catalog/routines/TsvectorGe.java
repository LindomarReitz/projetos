...
public class TsvectorGe extends org.jooq.impl.AbstractRoutine<java.lang.Boolean> {

	private static final long serialVersionUID = -960212196;


	/**
	 * The procedure parameter <code>pg_catalog.tsvector_ge.RETURN_VALUE</code>
	 */
	...
	/**
	 * The procedure parameter <code>pg_catalog.tsvector_ge._1</code>
	 * <p>
	...
	/**
	 * The procedure parameter <code>pg_catalog.tsvector_ge._2</code>
	 * <p>
	 * The SQL type of this item (tsvector) could not be mapped.<br/>
	 * Deserialising this field might not work!
	 */
	 ...
	 */
	public TsvectorGe() {
		super("tsvector_ge", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
	...
	public void set__1(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.TsvectorGe._1, value);
	}
	...
	public void set__2(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.TsvectorGe._2, value);
	}
