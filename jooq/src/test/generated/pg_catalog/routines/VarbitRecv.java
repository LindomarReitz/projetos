...
public class VarbitRecv extends org.jooq.impl.AbstractRoutine<java.lang.String> {

	private static final long serialVersionUID = 2085357705;


	/**
	 * The procedure parameter <code>pg_catalog.varbit_recv.RETURN_VALUE</code>
	 */
	...
	/**
	 * The procedure parameter <code>pg_catalog.varbit_recv._1</code>
	 * <p>
	...
	/**
	 * The procedure parameter <code>pg_catalog.varbit_recv._2</code>
	 */
	public static final org.jooq.Parameter<java.lang.Long> _2 = createParameter("_2", org.jooq.impl.SQLDataType.BIGINT);

	/**
	 * The procedure parameter <code>pg_catalog.varbit_recv._3</code>
	 */
	 ...
	 */
	public VarbitRecv() {
		super("varbit_recv", test.generated.pg_catalog.PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.VARCHAR);
	...
	public void set__1(java.lang.Object value) {
		setValue(test.generated.pg_catalog.routines.VarbitRecv._1, value);
	}
	...
	public void set__2(java.lang.Long value) {
		setValue(test.generated.pg_catalog.routines.VarbitRecv._2, value);
	}
	...
	public void set__3(java.lang.Integer value) {
		setValue(test.generated.pg_catalog.routines.VarbitRecv._3, value);
	}
